...
// and initializing it to have the value "0" which is the analog input pin the pot is
// conected to.
int sensorPin = 0;
...
void loop()
{
  ...
  //create a local variable (variable that can only be used inside of loop() to store
  //a sensor value called sensorValue
  int sensorValue;
